...
void ss_dynamic_modulator_system_setup_receiver(SS_DynamicModulatorSystem *dms,
	...
	switch(addr3 & 0x0f) {
		...
		case 0x01: {
			/* Cutoff */
			set_modulator(dms, source, SS_GEN_INITIAL_FILTER_FC, centeredNormalized * 9600.0, is_bipolar);
			break;
		}
		...
		case 0x02: {
			/* Amplitude */
			/* Generator is 1/10% */
			set_modulator(dms, source, SS_GEN_AMPLITUDE, centeredNormalized * 1000.0, is_bipolar);
			break;
		}
		...
		case 0x03: {
			...
			set_modulator(dms, source, SS_GEN_VIB_LFO_RATE, centeredNormalized * 1000.0, is_bipolar);
			break;
		}

		case 0x04: {
			set_modulator(dms, source, SS_GEN_VIB_LFO_TO_PITCH, normalizedNotCentered * 600.0, is_bipolar);
			break;
		}

		case 0x05: {
			/* LFO1 filter depth */
			set_modulator(dms, source, SS_GEN_VIB_LFO_TO_FILTER_FC, normalizedNotCentered * 2400.0, is_bipolar);
			break;
		}
		...
		case 0x06: {
			...
			/* Generator is 1/10% */
			set_modulator(dms, source, SS_GEN_VIB_LFO_AMPLITUDE_DEPTH, normalizedNotCentered * 1000.0, is_bipolar);
			break;
		}
		...
		case 0x07: {
			/* LFO1 rate */
			/* Generator is 1/100Hz */
			set_modulator(dms, source, SS_GEN_MOD_LFO_RATE, centeredNormalized * 1000.0, is_bipolar);
			break;
		}

		case 0x08: {
			/* LFO2 pitch depth */
			set_modulator(dms, source, SS_GEN_MOD_LFO_TO_PITCH, normalizedNotCentered * 600.0, is_bipolar);
			break;
		}

		case 0x09: {
			/* LFO2 filter depth */
			set_modulator(dms, source, SS_GEN_MOD_LFO_TO_FILTER_FC, normalizedNotCentered * 2400.0, is_bipolar);
			break;
		}
		...
		case 0x0a: {
			...
			/* Generator is 1/10% */
			set_modulator(dms, source, SS_GEN_MOD_LFO_AMPLITUDE_DEPTH, normalizedNotCentered * 1000.0, is_bipolar);
			break;
		}
	}
}
